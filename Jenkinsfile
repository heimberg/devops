            ...
            steps {
                gitlabCommitStatus(name: 'test with jmeter') {
                    sh '''
                        ...
                        docker run --rm -v ${PWD}/jmeter-data:/home/user/jmeter justb4/jmeter -n -t /home/user/jmeter/jmeter_tests/check_api.jmx -l /home/user/jmeter/jmeter_tests/result_"${TIMESTAMP}".jtl -j /home/user/jmeter/jmeter_tests/jmeter_"${TIMESTAMP}".log 
                    '''
                }
            }
        }
